...
/**
 * This is a sample program that implements the CardDeck API. It prompts the
 * user for specific options. The user then specifies which option to choose
 * from. This program is using Java 8.
 * 
 * @author Daniel Clark
 * @version 1.0 (Java 8)
 * @since 2018-06-18
    ...
    public static void promptUser() {
        ...
        switch (input.trim()) {
            ...
            case "2":
                ...
                break;
            case "3":
                cardDeck.getDeck().forEach(card -> System.out.println(card));
                break;
            case "4":
                System.out.println(cardDeck.getDeck().size());
                break;
            case "5":
                System.out.println("Goodbye! Y'all come back ya here!");
                System.exit(0);
                break;
            default:
