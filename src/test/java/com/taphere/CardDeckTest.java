...
/**
 * This program performs JUnit 4 tests on methods of
 * {@link com.taphere.CardDeck}
 * 
 * @author Daniel Clark
 * @version 1.0 (Java 8)
 * @since 2018-06-18
...
public class CardDeckTest {
    ...
    public void testShuffle() {
        ...
        cardDeck.dealOneCard();
        cardDeck.shuffle();
        assertEquals("deck is full after dealing and shuffling", 52, cardDeck.getDeck().size());
